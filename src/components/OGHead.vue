...
useHead({
  ...
  meta: [
    ...
    // Open Graph - Profile
    { property: 'profile:first_name', content: 'Rizumu' },
    { property: 'profile:last_name', content: 'Ayaka' },
    { property: 'profile:username', content: 'rizumu' },
    ...
    { name: 'twitter:image:alt', content: `${SITE_TITLE} - Profile` },
